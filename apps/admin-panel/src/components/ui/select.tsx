...
/**
 * Select estilo shadcn (envuelve Radix). Usado en filtros de tablas
 * (estado de verificación, profesión, comuna, etc).
 *
 * @example
 * <Select value={value} onValueChange={setValue}>
 *   <SelectTrigger><SelectValue placeholder="Todos" /></SelectTrigger>
 *   <SelectContent><SelectItem value="approved">Aprobado</SelectItem></SelectContent>
 * </Select>
 */
